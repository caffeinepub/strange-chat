...
export class Backend implements backendInterface {
    ...
    async checkMatchmakingStatus(): Promise<bigint | null> {
        if (this.processError) {
            try {
                const result = await this.actor.checkMatchmakingStatus();
    ...
    async createRoom(arg0: UserName, arg1: RoomCode): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getRoomMessages(arg0: bigint): Promise<Array<Message>> {
        if (this.processError) {
            try {
    ...
    async joinRoom(arg0: UserName, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async requestMatchmaking(arg0: RoomCode): Promise<UserName> {
        if (this.processError) {
            try {
                const result = await this.actor.requestMatchmaking(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendMessage(arg0: RoomCode, arg1: string): Promise<void> {
        if (this.processError) {
            try {
